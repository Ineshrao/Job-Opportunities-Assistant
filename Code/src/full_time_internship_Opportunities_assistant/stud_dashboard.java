...
public class stud_dashboard {
	...
	public void main(String username) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					stud_dashboard window = new stud_dashboard(username);
	 ...
	 */
	public stud_dashboard(String username) {
		initialize(username);
	}
	...
	private void initialize(String username) {
		...
		if(i==1)
		{
			...
			View.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					full_time_internship_0pportunities_assistant.company_page o = new full_time_internship_0pportunities_assistant.company_page(Company,username);
					o.main(Company,username);
				}
			});
			panel_dyn.add(View);
			...
			JLabel lblNewLabel_1_2 = new JLabel("CGPA Required : "+rs.getString(6));
		...
		else if(i==2)
		{
			...
			View1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					full_time_internship_0pportunities_assistant.company_page o = new full_time_internship_0pportunities_assistant.company_page(Company1,username);
					o.main(Company1,username);
				}
			});
			...
			JLabel lblNewLabel_1_21 = new JLabel("CGPA Required : "+rs.getString(6));
		...
		else if(i==3)
		{
			...
			View1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					full_time_internship_0pportunities_assistant.company_page o = new full_time_internship_0pportunities_assistant.company_page(Company2,username);
					o.main(Company2,username);
				}
			});
			panel_dyn1.add(View1);
			...
			JLabel lblNewLabel_1_22 = new JLabel("CGPA Required : "+rs.getString(6));
		...
		else if(i==4)
		{
			...
			JLabel lblNewLabel_1_21 = new JLabel("Required CGPA : "+rs.getString(3));
			lblNewLabel_1_21.setFont(new Font("Arial", Font.PLAIN, 25));
			lblNewLabel_1_21.setBounds(701, 10, 363, 59);
			panel_dyn1.add(lblNewLabel_1_21);
			...
			View3.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					full_time_internship_0pportunities_assistant.company_page o = new full_time_internship_0pportunities_assistant.company_page(Company3,username);
					o.main(Company3,username);
				}
			});
			...
			JLabel lblNewLabel_1_23 = new JLabel("CGPA Required : "+rs.getString(6));
		...
		else if(i==5)
		{
			...
			View4.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					full_time_internship_0pportunities_assistant.company_page o = new full_time_internship_0pportunities_assistant.company_page(Company4,username);
					o.main(Company4,username);
				}
			});
			...
			JLabel lblNewLabel_1_24 = new JLabel("CGPA Required : "+rs.getString(6));
